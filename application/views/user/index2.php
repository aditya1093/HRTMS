...
<!--[if lt IE 9]>
      <script src="<?php echo base_url();?>assets/_home/js/html5shiv.js"></script>
    <![endif]-->
<!-- Fav and touch icons -->
<link rel="apple-touch-icon-precomposed" sizes="144x144" href="<?php echo base_url();?>assets/_home/img/apple-touch-icon-144-precomposed.png">
<link rel="apple-touch-icon-precomposed" sizes="114x114" href="<?php echo base_url();?>assets/_home/img/apple-touch-icon-114-precomposed.png">
  ...
  <div id="header">
    ...
    <div id="top-menu-horizontal">
      <ul class="nav pull-right hidden-phone hidden-tablet">
        ...
        <li><a href="<?php echo base_url();?>assets/_home/services.html">Services</a></li>
        <li class="dropdown"><a href="<?php echo base_url();?>assets/_home/#" class="dropdown-toggle" data-toggle="dropdown">Features</a>
          <ul class="dropdown-menu">
            <li><a href="<?php echo base_url();?>assets/_home/FAQ.html">Faq</a></li>
            <li><a href="<?php echo base_url();?>assets/_home/typography.html">Typography</a></li>
            <li class="divider"></li>
            <li><a href="<?php echo base_url();?>assets/_home/pricing-table.html">Pricing table</a></li>
          </ul>
        </li>
        <li><a href="<?php echo base_url();?>assets/_home/about.html">About us</a></li>
  ...
  <div class="container">
    ...
    <div id="carousel">
      <div id="flexslider" class="flexslider">
        <ul class="slides carousel-inner">
          <li class="item" > <img src="<?php echo base_url();?>assets/_home/images/22.jpg" alt="image" />
          ...
          <li class="item" > <img src="<?php echo base_url();?>assets/_home/images/33.jpg" alt="image" />
            <div class="carousel-caption hidden-phone">
              <h4>Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit.</h4>
              <p> Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Cras mattis consectetur purus sit amet fermentum. Fusce dapibus. </p>
            </div>
          </li>
          <li class="item" > <img src="<?php echo base_url();?>assets/_home/images/11.jpg" alt="image" />
            <div class="carousel-caption hidden-phone">
              <h4>Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit.</h4>
              <p> Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Cras mattis consectetur purus sit amet fermentum. Fusce dapibus. </p>
            </div>
    ...
    <div class="row-fluid">
      <div class="span4 section-box">
        ...
        <img  src="<?php echo base_url();?>assets/_home/images/business-33.jpg" alt="image" />
        <p>Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Cras mattis consectetur purus sit amet fermentum. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus.</p>
        <p><a class="metro pull-right" href="<?php echo base_url();?>assets/_home/#">View details &raquo;</a></p>
      </div>
      <!-- end span4 section-box-->
      <div class="span4 section-box">
        <h4 class="section-heading">Amet Mauris</h4>
        <img src="<?php echo base_url();?>assets/_home/images/business-11.jpg" alt="image" >
        <p>Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Cras mattis consectetur purus sit amet fermentum. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus.</p>
        <p><a class="metro pull-right" href="<?php echo base_url();?>assets/_home/#">View details &raquo;</a></p>
      </div>
      <!-- end span4 section-box-->
      <div class="span4 section-box">
        ...
        <img src="<?php echo base_url();?>assets/_home/images/business-22.jpg" alt="image" >
        <p>Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Cras mattis consectetur purus sit amet fermentum. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus.</p>
        <p><a class="metro pull-right" href="<?php echo base_url();?>assets/_home/#">View details &raquo;</a></p>
      </div>
      <!-- end span4 section-box-->
    ...
    <div class="row">
      ...
      <div class="span3 section-box">
        <div class="preview"> <img  src="<?php echo base_url();?>assets/_home/images/Project-1.jpg" class="img-polaroid" style="width:96%;" alt="image" >
          <div class="overlay"> <a href="<?php echo base_url();?>assets/_home/images/Project-1.jpg" data-rel="lightbox" class="lightbox zoom-in"></a> <a href="<?php echo base_url();?>assets/_home/#" class="follow-link"></a> </div>
        </div>
        <p>Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Cras mattis consectetur purus sit amet fermentum. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus.</p>
        <p><a class="metro metro-green pull-right" href="<?php echo base_url();?>assets/_home/#">View details &raquo;</a></p>
      </div>
      <!-- end span3 -->
      <div class="span3 section-box">
        <div class="preview"> <img  src="<?php echo base_url();?>assets/_home/images/Project-2.jpg" class="img-polaroid" style="width:96%;" alt="image" >
          <div class="overlay"> <a href="<?php echo base_url();?>assets/_home/images/Project-2.jpg" data-rel="lightbox" class="lightbox zoom-in"></a> <a href="<?php echo base_url();?>assets/_home/#" class="follow-link"></a> </div>
        </div>
        <p>Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Cras mattis consectetur purus sit amet fermentum. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus.</p>
        <p><a class="metro metro-green pull-right" href="<?php echo base_url();?>assets/_home/#">View details &raquo;</a></p>
      </div>
      <!-- end span3 -->
      <div class="span3 section-box">
        <div class="preview"> <img  src="<?php echo base_url();?>assets/_home/images/Project-3.jpg" class="img-polaroid" style="width:96%;" alt="image" >
          <div class="overlay"> <a href="<?php echo base_url();?>assets/_home/images/Project-3.jpg" data-rel="lightbox" class="lightbox zoom-in"></a> <a href="<?php echo base_url();?>assets/_home/#" class="follow-link"></a> </div>
        </div>
        <p>Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Cras mattis consectetur purus sit amet fermentum. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus.</p>
        <p><a class="metro metro-green pull-right" href="<?php echo base_url();?>assets/_home/#">View details &raquo;</a></p>
      </div>
      <!-- end span3 -->
      <div class="span3 section-box">
        <div class="preview"> <img  src="<?php echo base_url();?>assets/_home/images/Project-4.jpg" class="img-polaroid" style="width:96%;" alt="image" >
          <div class="overlay"> <a href="<?php echo base_url();?>assets/_home/images/Project-4.jpg" data-rel="lightbox" class="lightbox zoom-in"></a> <a href="<?php echo base_url();?>assets/_home/#" class="follow-link"></a> </div>
        </div>
        <p>Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Cras mattis consectetur purus sit amet fermentum. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus.</p>
        <p><a class="metro metro-green pull-right" href="<?php echo base_url();?>assets/_home/#">View details &raquo;</a></p>
      </div>
...
<script type="text/javascript" src="<?php echo base_url();?>assets/_home/js/jquery-1.8.3.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>assets/_home/js/bootstrap.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>assets/_home/js/holder.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>assets/_home/js/jquery.flexslider.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>assets/_home/js/lightbox.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>assets/_home/js/jquery.backgroundpos.js"></script>
<script type="text/javascript" src="<?php echo base_url();?>assets/_home/js/custom.js">
